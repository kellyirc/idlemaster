...
public class DummyUsable {
	...
	public static DummyUsable[] dummyItems = {
		...
		new DummyUsable("minuteglass", 	500, "The Sands of Time: every flip of the glass is a minute.", true, false),
		...
		new DummyUsable("weekglass", 		550000, "The Sands of Time: every flip of the glass is a week.", true, false),
		new DummyUsable("lifeglass", 			2300000, "The Sands of Time: every flip of the glass is a lifetime.", true, false),
		new DummyUsable("crystalshard", 	1500, "A shiny, translucent crystal with a glowing purple center.", true, true),
		...
		new DummyUsable("crystalball", 		535000, "A translucent orb carved out of a solid crystal, with a swirling, stormy core.", true, false),
		new DummyUsable("boo", 				65000, "A mean ghost.", true, false),
		new DummyUsable("megaboo", 		110000, "A really mean ghost.", false, true),
		new DummyUsable("pocketwatch", 	100000, "A small pocketwatch.", true, true),
		new DummyUsable("bomb", 				50000, "A dangerous explosive.", true, true),
		new DummyUsable("mirv", 				250000, "A really dangerous explosive.", false, true),
		...
		new DummyUsable("wishingwell", 	146000, "A giant well. How are you supposed to carry this around?", true, false),
		new DummyUsable("wishingfountain", 	756000, "An enormous fountain. Do you have a packmule?", true, false),
		...
		new DummyUsable("genielamp", 		760000, "A solid gold lamp.", true, true),
		new DummyUsable("geniilamp", 		120000, "A solid bronze lamp.", true, true),
		new DummyUsable("abacus", 			100000, "Just how do you use this thing?", true, true),
		new DummyUsable("flagofvalor", 		35000, "This flag incites valor in all who see it!", true, true),
		new DummyUsable("philosopherstone", 1150000, "A small, chromatic gem.", true, false),
		new DummyUsable("wingedshoes", 	375000, "A pair of shoes with wings attached to them. Nothing special.", true, false),
	};
