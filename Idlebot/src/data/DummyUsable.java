...
public class DummyUsable {
	...
	public static DummyUsable[] dummyItems = {
		...
		new DummyUsable("duelshard", 		112500, "A silver, translucent crystal shaped like a sword."),
		new DummyUsable("fightshard", 		124500, "A shiny, translucent crystal with a glowing red center."),
		new DummyUsable("goldshard", 		146500, "A miniature chunk of a well-known gold cluster."),
		new DummyUsable("starshard", 		168500, "A small, star-shaped crystal."),
