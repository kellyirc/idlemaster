...
public class DummyUsable {
	...
	public static DummyUsable[] dummyItems = {
		...
		new DummyUsable("starshard", 		255000, "A small, star-shaped crystal.", false, true),
		new DummyUsable("crystalball", 		185000, "A translucent orb carved out of a solid crystal, with a swirling, stormy core.", true, true),
